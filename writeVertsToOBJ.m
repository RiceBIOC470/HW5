function writeVertsToOBJ(XYZ,fullfilename)
% slight modification of write_wobj (see below)
%
% writeVertsToOBJ(X,Y,Z,fullfilename)
%
% XYZ :             Nx3 array with coordinates of points
% fullfilename:     e.g. pointCloud.obj
